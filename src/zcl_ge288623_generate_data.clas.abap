CLASS zcl_GE288623_generate_data DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_GE288623_generate_data IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.
    DATA demo_data TYPE STANDARD TABLE OF zGE288623.
    DATA demo_data_line TYPE zGE288623.
    ...
    INSERT zGE288623 FROM TABLE @demo_data.

    COMMIT WORK.

    SELECT * FROM zGE288623 INTO TABLE @demo_data.
